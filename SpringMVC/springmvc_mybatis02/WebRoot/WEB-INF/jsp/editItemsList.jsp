...
<tr>
	<td><input type="text" name="itemsCustomMap['x${s.index }'].name" value="${item.name }"/></td>
	<td><input type="text" name="itemsCustomMap['y${s.index}'].price" value="${item.price }"/></td>
	<td><input type="text" name="itemsCustomMap['z${s.index }'].createtime" value="${item.createtime }"/></td>
	<td><input type="text" name="itemsCustomMap['v${s.index }'].detail" value="${item.detail }"/></td>
